...
enum ts_symbol_identifiers {
  ...
  aux_sym_table_header_repeat1 = 102,
  aux_sym_table_values_repeat1 = 103,
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym_string] = STATE(19),
    [sym_table] = STATE(19),
    [sym_filesize] = STATE(19),
    [sym_duration] = STATE(19),
    [sym__nuon_value] = STATE(19),
    [sym_list] = STATE(19),
    [sym_record] = STATE(19),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [45] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_document_repeat1, 2, 0, 0), SHIFT_REPEAT(11),
  [48] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 2, 0, 0), SHIFT_REPEAT(28),
  [51] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_document_repeat1, 2, 0, 0), SHIFT_REPEAT(2),
  [54] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_document_repeat1, 2, 0, 0), SHIFT_REPEAT(19),
  [57] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 2, 0, 0), SHIFT_REPEAT(4),
  [60] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 2, 0, 0), SHIFT_REPEAT(19),
  [63] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_document_repeat1, 2, 0, 0), SHIFT_REPEAT(26),
  ...
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 4, 0, 0),
  [82] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_record, 4, 0, 0),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list, 2, 0, 0),
  [86] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_list, 2, 0, 0),
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_table, 3, 0, 2),
  [90] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_table, 3, 0, 2),
  ...
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_duration, 2, 0, 1),
  [102] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_duration, 2, 0, 1),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_filesize_unit, 1, 0, 0),
  [106] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_filesize_unit, 1, 0, 0),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 3, 0, 0),
  [110] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_record, 3, 0, 0),
  ...
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_filesize, 2, 0, 1),
  [122] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_filesize, 2, 0, 1),
  ...
  [142] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__string_content, 2, 0, 0),
  [144] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__string_content, 2, 0, 0), SHIFT_REPEAT(30),
  [147] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_table_repeat1, 2, 0, 0), SHIFT_REPEAT(8),
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_table_repeat1, 2, 0, 0),
  [152] = {.entry = {.count = 1, .reusable = true}}, SHIFT(23),
  [154] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_record_repeat1, 2, 0, 0), SHIFT_REPEAT(32),
  [157] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_record_repeat1, 2, 0, 0),
  ...
  [169] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_table_values_repeat1, 2, 0, 0), SHIFT_REPEAT(10),
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_table_values_repeat1, 2, 0, 0),
  ...
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_table_values, 2, 0, 0),
  [184] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_table_repeat1, 1, 0, 0),
  [186] = {.entry = {.count = 1, .reusable = true}}, SHIFT(49),
  [188] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_table_values, 4, 0, 0),
  [190] = {.entry = {.count = 1, .reusable = true}}, SHIFT(56),
  [192] = {.entry = {.count = 1, .reusable = true}}, SHIFT(44),
  [194] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_table_header_repeat1, 2, 0, 0), SHIFT_REPEAT(57),
  [197] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_table_header_repeat1, 2, 0, 0),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_table_values, 3, 0, 0),
  [201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pair, 3, 0, 3),
  [203] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_table_header, 5, 0, 0),
  [205] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_table_header, 4, 0, 0),
